...
-- Fix RLS policies with correct PostgreSQL syntax
...
INSERT INTO audit_trail (
  ...
  'Applied critical security fixes: secured sensitive tables (security_exceptions, subscription_modules, external_insights) with proper RLS policies and hardened 11 database functions with search_path protection'
);