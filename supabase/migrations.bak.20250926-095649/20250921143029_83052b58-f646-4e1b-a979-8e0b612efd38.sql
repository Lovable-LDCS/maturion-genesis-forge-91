-- SECURITY REMEDIATION: Phase 2 - Fix remaining critical issues
...
-- Continue fixing SECURITY DEFINER functions without search_path
-- These are high-priority due to privilege escalation risks
...
-- Fix count_chunks_by_organization function
