...
-- ALTER TABLE public.org_domains
--   ADD CONSTRAINT IF NOT EXISTS org_domains_org_fk
--   FOREIGN KEY (organization_id) REFERENCES public.organizations(id);

-- 4) Upsert De Beers domains (keeps audit history)
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS org_domains_org_id_domain_uidx
  ON public.org_domains (org_id, domain);

ALTER TABLE public.org_domains
  ADD CONSTRAINT IF NOT EXISTS org_domains_org_id_domain_unique
  UNIQUE USING INDEX org_domains_org_id_domain_uidx;