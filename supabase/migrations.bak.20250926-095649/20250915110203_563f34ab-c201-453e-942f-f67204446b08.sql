...
-- Fix GIN indexes with proper operator classes
CREATE INDEX IF NOT EXISTS ai_docs_tags_gin ON ai_documents USING gin(tags array_ops) WHERE tags IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS ai_chunks_equipment_gin ON ai_document_chunks USING gin(equipment_slugs array_ops) WHERE equipment_slugs IS NOT NULL;
CREATE INDEX IF NOT EXISTS ai_chunks_tags_gin ON ai_document_chunks USING gin(tags array_ops) WHERE tags IS NOT NULL;
