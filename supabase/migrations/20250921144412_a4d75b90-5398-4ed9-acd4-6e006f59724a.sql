...
-- Fix RLS policies for tables and secure database functions (corrected syntax)
...
CREATE POLICY "Admin users can access security exceptions"
...
CREATE POLICY "Admin users can modify subscription modules"
ON public.subscription_modules
...
CREATE POLICY "Admin users can modify external insights"
ON public.external_insights
FOR INSERT, UPDATE, DELETE
TO authenticated
USING (
...
INSERT INTO audit_trail (
  ...
  'Applied critical fixes: secured sensitive tables with proper RLS, and hardened 11 database functions with search_path protection against SQL injection'
);