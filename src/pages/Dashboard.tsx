...
import { LinkedOrganizationSetup } from '@/components/organization/LinkedOrganizationSetup';
...
const Dashboard = () => {
  ...
  if (showOrgSetup) {
    return <LinkedOrganizationSetup onComplete={handleOrgSetupComplete} variant="dashboard" />;
  }
