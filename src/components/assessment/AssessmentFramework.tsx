...
export const AssessmentFramework: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-2">Assessment Framework</h2>
        <p className="text-muted-foreground">
          Comprehensive database foundation for assessment framework with status lifecycle, AI integration, and audit trail
        </p>
      </div>
